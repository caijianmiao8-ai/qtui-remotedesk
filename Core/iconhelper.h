...
private:
    ...
    static void drawMinus(QPainter &painter, const QRectF &rect);
    static void drawMaximize(QPainter &painter, const QRectF &rect);
    static void drawClose(QPainter &painter, const QRectF &rect);
    static void drawChevronRight(QPainter &painter, const QRectF &rect);
};
