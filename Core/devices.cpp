...
QWidget *Devices::createStatusBadge(bool online) const
{
    ...
    badge->setStyleSheet(QString(
        ...
        "        stop:1 rgba(%1,%2,%3,%5));"
        "    border-radius: 999px;"
        "    border: 1px solid rgba(%1,%2,%3,%6);"
        "}" )
        .arg(color.red())
        .arg(color.green())
        .arg(color.blue())
        .arg(online ? "0.24" : "0.16")
        .arg(online ? "0.12" : "0.1")
        .arg(online ? "0.3" : "0.2"));
    ...
    dot->setStyleSheet(QString(
                             ...
                             "        stop:0 rgba(%1,%2,%3,1), stop:1 rgba(%1,%2,%3,0.08));"
                             "    border-radius: 4px;"
                             "}")
                           .arg(color.red())
                           .arg(color.green())
...
QFrame *Devices::buildDeviceCard(const DeviceInfo &info) const
{
    ...
    iconBadge->setStyleSheet(QString(
        ...
        .arg(info.online
                 ...
                 : "qlineargradient(x1:0,y1:0,x2:1,y2:1, stop:0 rgba(148,163,184,0.55), stop:1 rgba(148,163,184,0.38))")
        .arg(info.online ? "rgba(10,132,255,0.32)" : "rgba(148,163,184,0.35)"));
